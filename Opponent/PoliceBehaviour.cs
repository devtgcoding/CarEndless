    ...
    void Awake()
    {
        ...
        switch (environmentManager.currentEnvironment)
        {
            case OnTheRunEnvironment.Environments.Europe:
                gameObject.transform.FindChild("police_car").renderer.material = policeMaterials[2];
                break;
            case OnTheRunEnvironment.Environments.Asia:
                gameObject.transform.FindChild("police_car").renderer.material = policeMaterials[1];
                break;
            case OnTheRunEnvironment.Environments.USA:
                gameObject.transform.FindChild("police_car").renderer.material = policeMaterials[3];
                break;
            case OnTheRunEnvironment.Environments.NY:
                gameObject.transform.FindChild("police_car").renderer.material = policeMaterials[0];
                break;
        }
