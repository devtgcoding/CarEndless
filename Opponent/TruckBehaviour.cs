    ...
    void InitializeTruckForGarage(int index)
    {
       ...
       /* if (spawnManager == null)
        ...
        if (currSpecialCarData.locked)
        {
            ...
            switch (fakeCarType)
            {
                ...
                case TrasformType.Ufo:
                    ...
                    BackupShadowMat = shadow.renderer.material;
                    shadow.renderer.material = fakeUfoShadowMat;
                ...
                case TrasformType.Plane:
                    ...
                    fakeCarInstance.transform.localRotation = Quaternion.Euler(0.0f ,180.0f, 0.0f);
                    BackupShadowMat = shadow.renderer.material;
                    shadow.renderer.material = fakePlaneShadowMat;
        ...
        else
        {
            ...
            {
                shadow.renderer.material = BackupShadowMat;
