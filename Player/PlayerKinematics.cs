...
public class PlayerKinematics : MonoBehaviour
{
    ...
    void InitializeLifting()
    {
        ...
        float playerForwardSpeed = Mathf.Max(rb.velocity.z, truckInUse.gameObject.rigidbody.velocity.z + 50.0f);
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        {
            collision.collider.SendMessage("OnPlayerWithShieldCollison", collider, SendMessageOptions.DontRequireReceiver);
            return;
        }
